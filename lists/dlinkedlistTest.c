...
void free_helper(dlinkedlist *l) {
    d_node *cur = l->dummy_head, *removeNode = l->dummy_head;
    l->dummy_head = NULL;
...
void test_constructor() {
    ...
    dlinkedlist l = constructor();

    assert(l.dummy_head != NULL);
    printf("Test passed: l.dummy_head != NULL\n");
    assert(l.dummy_tail != NULL);
    printf("Test passed: l.dummy_tail != NULL\n");
    assert(l.dummy_head->prev == NULL);
    printf("Test passed: l.dummy_head->prev == NULL\n");
    assert(l.dummy_head->next == l.dummy_tail);
    printf("Test passed: l.dummy_head->next == l.dummy_tail\n");
    assert(l.dummy_tail->next == NULL);
    printf("Test passed: l.dummy_tail->next == NULL\n");
    assert(l.dummy_tail->prev == l.dummy_head);
    printf("Test passed: l.dummy_tail->prev == l.dummy_head\n");
    assert(l.size == 0);
...
void test_push() {
    ...
    assert(l.dummy_head != NULL);
    printf("Test passed: l.dummy_head != NULL\n");
    assert(((data_node*) l.dummy_head->next->item)->item == 69);
    printf("Test passed: ((data_node*) l.dummy_head->next->item)->item == 69\n");
    assert(((data_node*) l.dummy_tail->prev->item)->item == 69);
    printf("Test passed: ((data_node*) l.dummy_tail->prev->item)->item == 69\n");
    assert(l.dummy_head->next->next == l.dummy_tail);
    printf("Test passed: l.dummy_head->next->next == l.dummy_tail\n");
...
void test_pop() {
    ...
    d_node *cur = l.dummy_head->next;
    for (int i = 0; i < 3; i++) {
        assert(((data_node*)cur->item)->item == 69 - i);
        cur = cur->next;
    }
    printf("Test passed: list == {69, 68, 67}\n");
    assert(cur == l.dummy_tail);
    printf("Test passed: cur == l.dummy_tail\n");
    assert(old == 66);
    printf("Test passed: old == 66\n");
    printf("------------ End Test 2 ------------\n");
